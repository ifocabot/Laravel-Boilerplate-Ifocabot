    ...
    public function run(): void
    {
        ...
        $components = [
            ...
            [
                ...
                'default_amount' => 5000000.00, // ERP: Default 5 juta
                'proration_type' => 'attendance',
                'forfeit_on_alpha' => false,
                'forfeit_on_late' => false,
                'min_attendance_percent' => null,
                'calculation_notes' => 'Gaji pokok bulanan, prorata berdasarkan kehadiran. Default 5 juta, bisa override per karyawan.',
            ...
            [
                ...
                'rate_per_hour' => null,
                'percentage_value' => null,
                'proration_type' => 'none', // Already daily, no additional proration
                'forfeit_on_alpha' => true, // Forfeit if any alpha
                'forfeit_on_late' => false,
                'min_attendance_percent' => 80, // Min 80% attendance
                'calculation_notes' => 'Rp 50,000 per hari hadir. Hangus jika ada alpha atau kehadiran <80%',
            ...
            [
                ...
                'percentage_value' => null,
                'proration_type' => 'none',
                'forfeit_on_alpha' => true,
                'forfeit_on_late' => true, // Also forfeit if late
                'min_attendance_percent' => 90, // Stricter: 90%
                'calculation_notes' => 'Rp 30,000 per hari hadir. Hangus jika alpha/terlambat atau kehadiran <90%',
