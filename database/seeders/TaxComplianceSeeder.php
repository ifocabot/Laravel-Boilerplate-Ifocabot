...
class TaxComplianceSeeder extends Seeder
{
    /**
     * Seed official TER rates per PP 58/2023
     * 
     * TER Category:
     * A = TK/0, TK/1 (tidak kawin, 0-1 tanggungan)
     * B = K/0, K/1, K/2 (kawin, 0-2 tanggungan)
    ...
    public function run(): void
    {
        ...
        if (TaxTerBracket::where('effective_from', $effectiveFrom)->exists()) {
            $this->command?->info('Tax compliance data already exists, skipping...');
            return;
        }

        // ========================================
        // TER CATEGORY A (TK/0, TK/1)
        // ========================================
        $terA = [
