    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tambah skill/kompetensi baru</p>
            </div>
        ...
        <form action="{{ route('hris.training.skills.store') }}" method="POST"
            ...
            <div>
                <label for="skill_category_id" class="block text-sm font-medium text-gray-700 mb-2">Kategori *</label>
                <select name="skill_category_id" id="skill_category_id" required
                ...
                @error('skill_category_id')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
            </div>
            <div>
