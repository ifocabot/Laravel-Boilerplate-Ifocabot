...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Periode Payroll</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola periode payroll bulanan</p>
            </div>
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('hris.payroll.periods.create') }}"
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mt-2">{{ $totalPeriods }}</h3>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mt-2">{{ $draftPeriods }}</h3>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mt-2">{{ $approvedPeriods }}</h3>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mt-2">{{ $paidPeriods }}</h3>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form method="GET" action="{{ route('hris.payroll.periods.index') }}" class="flex items-end gap-4">
                <div class="flex-1">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
                <h2 class="text-lg font-bold text-gray-900">Daftar Periode Payroll</h2>
            </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">{{ $period->period_name }}</p>
                                                <p class="text-xs text-gray-500">{{ $period->period_code }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            ...
                                            <p class="text-xs text-gray-500">
                                                Payment: {{ $period->payment_date->format('d M Y') }}
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            <p class="text-gray-900 font-semibold">{{ $period->total_employees }}</p>
                                            <p class="text-xs text-gray-500">karyawan</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            <p class="text-gray-900 font-semibold">{{ $period->formatted_net_salary }}</p>
                                            <p class="text-xs text-gray-500">Net Salary</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold {{ $period->status_badge_class }}">
                                            {{ ucfirst($period->status) }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="{{ route('hris.payroll.periods.show', $period->id) }}"
                                            ...
                                            @if($period->status === 'draft')
                                                <form action="{{ route('hris.payroll.periods.destroy', $period->id) }}" method="POST"
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 text-sm font-medium mb-1">Belum ada periode payroll</p>
                    <p class="text-gray-400 text-sm mb-4">Mulai dengan membuat periode payroll pertama</p>
                    <a href="{{ route('hris.payroll.periods.create') }}"
