        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Shift Baru</h1>
                </div>
                <p class="text-sm text-gray-500 ml-11">Buat jadwal shift untuk karyawan</p>
            </div>
        </div>

        <form action="{{ route('hris.attendance.shifts.store') }}" method="POST">
            @csrf
                ...
                <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                    ...
                                    placeholder="Contoh: Regular Day Shift">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="code" id="code" required
                                    ...
                                    placeholder="SH001">
                                <p class="mt-1.5 text-xs text-gray-500">Kode unik untuk identifikasi shift</p>
                                @error('code')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required x-model="shiftType"
                                    ...
                                    <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Fixed - Jam Tetap</option>
                                    <option value="flexible" {{ old('type') == 'flexible' ? 'selected' : '' }}>Flexible - Jam Fleksibel</option>
                                </select>
                                <p class="mt-1.5 text-xs text-gray-500">
                                    <span x-show="shiftType === 'fixed'">Karyawan harus masuk/pulang di jam yang ditentukan</span>
                                    <span x-show="shiftType === 'flexible'">Karyawan bebas masuk/pulang asal memenuhi durasi wajib</span>
                                </p>
                                @error('type')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="work_hours_required" id="work_hours_required" required
                                    value="{{ old('work_hours_required', 480) }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-500">Opsional - Waktu mulai istirahat</p>
                                @error('break_start')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-500">Opsional - Waktu selesai istirahat</p>
                                @error('break_end')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-500">Grace period sebelum dianggap terlambat</p>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3 mt-3">
                                    <input type="checkbox" name="is_overnight" id="is_overnight" value="1"
                                        {{ old('is_overnight') ? 'checked' : '' }}
                                        class="w-5 h-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="is_overnight" class="text-sm text-gray-700 cursor-pointer">
                                        Ya, shift ini melewati tengah malam (misal: 22:00 - 06:00)
                                    </label>
                                </div>
                                <p class="mt-1.5 text-xs text-gray-500">Centang jika shift dimulai hari ini dan selesai besok</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="Deskripsi tambahan tentang shift ini (opsional)">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <ul class="text-xs text-blue-700 space-y-1">
                                    <li>• <strong>Fixed Shift:</strong> Karyawan harus clock in/out sesuai jadwal. Keterlambatan dihitung.</li>
                                    <li>• <strong>Flexible Shift:</strong> Karyawan bebas clock in/out asal memenuhi durasi kerja wajib.</li>
                                    <li>• Istirahat tidak dihitung sebagai waktu kerja.</li>
                                    <li>• Overnight shift: untuk shift yang melewati tengah malam (misal: shift malam 22:00-06:00).</li>
                                </ul>
                            </div>
                        </div>
                    </div>
