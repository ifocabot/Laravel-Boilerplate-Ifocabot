                            ...
                            <template x-for="(step, index) in steps" :key="index">
                                <div class="bg-gray-50 rounded-xl p-4 relative">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Nilai/Parameter</label>
                                            ...
                                            <template x-if="['direct_supervisor', 'department_head', 'cost_center_owner', 'next_level_up', 'second_level_up'].includes(step.approver_type)">
                                            ...
                                            <input type="hidden" :name="'steps[' + index + '][approver_value]'"
                                                x-model="step.approver_value" x-show="['direct_supervisor', 'department_head', 'cost_center_owner'].includes(step.approver_type)">
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Jika Gagal Resolve</label>
                                    ...
                                    <div class="mt-4 pt-4 border-t border-gray-200">
                                        ...
                                        <template x-if="!step.conditions || step.conditions.length === 0">
                                            <p class="text-xs text-gray-400 italic">Tidak ada kondisi - step akan selalu aktif</p>
                                        </template>
