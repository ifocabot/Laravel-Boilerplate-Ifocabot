                                ...
                                <div class="bg-gray-50 rounded-xl p-4 relative">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <template
                                                x-if="step.approver_type === 'direct_supervisor' || step.approver_type === 'next_level_up' || step.approver_type === 'second_level_up'">
                                            ...
                                            <input type="hidden" :name="'steps[' + index + '][approver_value]'"
                                                ...
                                                x-show="step.approver_type === 'direct_supervisor'">
                                        </div>
                                    </div>
    ...
    @push('scripts')
        <script>
            function workflowForm() {
                return {
                    steps: [
                        { approver_type: 'direct_supervisor', approver_value: '', can_skip_if_same: true }
                    ],
